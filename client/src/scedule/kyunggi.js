...
const rows = [
  createData('07:00', '파주시 A 농구코트', 1),
  createData('14:00', '성남시 B 농구코드',2),
  createData('18:00', '안산시 C 농구코드',3 ),
  createData('18:30', '수원시 D 농구코드',4 ),
  createData('19:00', '이천시 E 농구코드',5),
  createData('20:00', '평택시 F 농구코드',6),
];
